...
public extension FileManager {
  ...
  enum GetFileManagerFoldersId {
    public static let service = Service<Response>(id: "getFileManagerFoldersId", tag: "fileManager", method: "GET", path: "/file-manager/folders/{folder_id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public final class Request: Prch.Request<Response, MailchimpAPI> {
      ...
      public init(options: Options) {
        ...
        super.init(service: GetFileManagerFoldersId.service)
      }
      ...
      override public var path: String {
        super.path.replacingOccurrences(of: "{" + "folder_id" + "}", with: "\(self.options.folderId)")
      }
