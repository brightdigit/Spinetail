...
public extension FileManager {
  ...
  enum GetFileManagerFilesId {
    public static let service = Service<Response>(id: "getFileManagerFilesId", tag: "fileManager", method: "GET", path: "/file-manager/files/{file_id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public final class Request: Prch.Request<Response, MailchimpAPI> {
      ...
      public init(options: Options) {
        ...
        super.init(service: GetFileManagerFilesId.service)
      }

      /// convenience initialiser so an Option doesn't have to be created
      public convenience init(fields: [String]? = nil, excludeFields: [String]? = nil, fileId: String) {
        let options = Options(fields: fields, excludeFields: excludeFields, fileId: fileId)
        self.init(options: options)
      }

      override public var path: String {
        super.path.replacingOccurrences(of: "{" + "file_id" + "}", with: "\(self.options.fileId)")
      }
