...
import Prch
    ...
    public extension LandingPages {
      ...
      enum PostAllLandingPages {
        public static let service = Service<Response>(id: "postAllLandingPages", tag: "landingPages", method: "POST", path: "/landing-pages", hasBody: true, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
        ...
        public struct Request: ServiceRequest {
          ...
          public struct Body: Model {
            ...
            public init(description: String? = nil, listId: String? = nil, name: String? = nil, storeId: String? = nil, templateId: Int? = nil, title: String? = nil, tracking: Tracking? = nil, type: Type? = nil) {
          ...
          public struct Options {
            ...
            public init(useDefaultList: Bool? = nil) {
          ...
          public var service: Service<Response> {
            PostAllLandingPages.service
          }

          /// convenience initialiser so an Option doesn't have to be created
          public init(useDefaultList: Bool? = nil, body: Body) {
            let options = Options(useDefaultList: useDefaultList)
            self.init(body: body, options: options)
          }

          public var queryParameters: [String: Any] {
            var params: [String: Any] = [:]
            if let useDefaultList = options.useDefaultList {
              params["use_default_list"] = useDefaultList
            }
            return params
          }
        }
