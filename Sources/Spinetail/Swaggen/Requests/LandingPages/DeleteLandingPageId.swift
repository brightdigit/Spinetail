...
import Prch
  ...
  public extension LandingPages {
    ...
    enum DeleteLandingPageId {
      public static let service = Service<Response>(id: "deleteLandingPageId", tag: "landingPages", method: "DELETE", path: "/landing-pages/{page_id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
      ...
      public final class Request: Prch.Request<Response, MailchimpAPI> {
        ...
        public init(options: Options) {
          ...
          super.init(service: DeleteLandingPageId.service)
        }
