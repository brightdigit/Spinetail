  ...
  enum GetEcommerceStoresIdProductsIdVariantsId {
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(options: Options) {
        ...
        super.init(service: GetEcommerceStoresIdProductsIdVariantsId.service)
      }
      ...
      public convenience init(fields: [String]? = nil, excludeFields: [String]? = nil, storeId: String, productId: String, variantId: String) {
        let options = Options(fields: fields, excludeFields: excludeFields, storeId: storeId, productId: productId, variantId: variantId)
        self.init(options: options)
      }

      override public var path: String {
        super.path.replacingOccurrences(of: "{" + "store_id" + "}", with: "\(self.options.storeId)").replacingOccurrences(of: "{" + "product_id" + "}", with: "\(self.options.productId)").replacingOccurrences(of: "{" + "variant_id" + "}", with: "\(self.options.variantId)")
      }
