...
import Prch
  ...
  public extension Ecommerce {
    ...
    enum GetEcommerceStoresIdProductsIdVariantsId {
      public static let service = Service<Response>(id: "getEcommerceStoresIdProductsIdVariantsId", tag: "ecommerce", method: "GET", path: "/ecommerce/stores/{store_id}/products/{product_id}/variants/{variant_id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
