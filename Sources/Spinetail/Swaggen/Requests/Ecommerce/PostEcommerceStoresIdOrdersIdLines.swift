...
import Prch
  ...
  public extension Ecommerce {
    ...
    enum PostEcommerceStoresIdOrdersIdLines {
      public static let service = Service<Response>(id: "postEcommerceStoresIdOrdersIdLines", tag: "ecommerce", method: "POST", path: "/ecommerce/stores/{store_id}/orders/{order_id}/lines", hasBody: true, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
      ...
      public final class Request: Prch.Request<Response, MailchimpAPI> {
        ...
        public init(body: Body, options: Options, encoder: RequestEncoder? = nil) {
          ...
          super.init(service: PostEcommerceStoresIdOrdersIdLines.service) { defaultEncoder in
        ...
        override public var path: String {
          super.path.replacingOccurrences(of: "{" + "store_id" + "}", with: "\(options.storeId)").replacingOccurrences(of: "{" + "order_id" + "}", with: "\(options.orderId)")
        }
      }
