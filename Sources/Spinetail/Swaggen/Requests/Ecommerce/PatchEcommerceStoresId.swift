...
public extension Ecommerce {
  ...
  enum PatchEcommerceStoresId {
    public static let service = Service<Response>(id: "patchEcommerceStoresId", tag: "ecommerce", method: "PATCH", path: "/ecommerce/stores/{store_id}", hasBody: true, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public final class Request: Prch.Request<Response, MailchimpAPI> {
      ...
      public struct Body: Model {
        ...
        public init(address: Address? = nil, currencyCode: String? = nil, domain: String? = nil, emailAddress: String? = nil, isSyncing: Bool? = nil, moneyFormat: String? = nil, name: String? = nil, phone: String? = nil, platform: String? = nil, primaryLocale: String? = nil, timezone: String? = nil) {
      ...
      public init(body: Body, options: Options, encoder: RequestEncoder? = nil) {
        ...
        super.init(service: PatchEcommerceStoresId.service) { defaultEncoder in
