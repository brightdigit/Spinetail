...
public extension Ecommerce {
  ...
  enum GetEcommerceStoresIdPromorules {
    public static let service = Service<Response>(id: "getEcommerceStoresIdPromorules", tag: "ecommerce", method: "GET", path: "/ecommerce/stores/{store_id}/promo-rules", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public final class Request: Prch.Request<Response, MailchimpAPI> {
      ...
      public init(options: Options) {
        ...
        super.init(service: GetEcommerceStoresIdPromorules.service)
      }
    ...
    public enum Response: Prch.Response, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public struct Status200: Model {
        ...
        public var promoRules: [PromoRules]?
        ...
        public init(links: [Links]? = nil, promoRules: [PromoRules]? = nil, storeId: String? = nil, totalItems: Int? = nil) {
          self.links = links
