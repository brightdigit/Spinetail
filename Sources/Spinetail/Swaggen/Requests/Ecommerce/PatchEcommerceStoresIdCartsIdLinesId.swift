  ...
  enum PatchEcommerceStoresIdCartsIdLinesId {
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(body: Body, options: Options, encoder: RequestEncoder? = nil) {
        ...
        super.init(service: PatchEcommerceStoresIdCartsIdLinesId.service) { defaultEncoder in
      ...
      override public var path: String {
        super.path.replacingOccurrences(of: "{" + "store_id" + "}", with: "\(options.storeId)").replacingOccurrences(of: "{" + "cart_id" + "}", with: "\(options.cartId)").replacingOccurrences(of: "{" + "line_id" + "}", with: "\(options.lineId)")
      }
    }
