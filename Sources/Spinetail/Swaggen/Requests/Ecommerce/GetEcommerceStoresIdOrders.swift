  ...
  enum GetEcommerceStoresIdOrders {
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(options: Options) {
        ...
        super.init(service: GetEcommerceStoresIdOrders.service)
      }
      ...
      public convenience init(fields: [String]? = nil, excludeFields: [String]? = nil, count: Int? = nil, offset: Int? = nil, storeId: String, customerId: String? = nil, hasOutreach: Bool? = nil, campaignId: String? = nil, outreachId: String? = nil) {
        let options = Options(fields: fields, excludeFields: excludeFields, count: count, offset: offset, storeId: storeId, customerId: customerId, hasOutreach: hasOutreach, campaignId: campaignId, outreachId: outreachId)
    ...
    public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public struct Status200: Model {
        ...
        public init(links: [Links]? = nil, orders: [Orders]? = nil, storeId: String? = nil, totalItems: Int? = nil) {
          self.links = links
          self.orders = orders
          self.storeId = storeId
