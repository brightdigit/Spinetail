...
public extension Ecommerce {
  ...
  enum DeleteEcommerceStoresIdOrdersIdLinesId {
    public static let service = Service<Response>(id: "deleteEcommerceStoresIdOrdersIdLinesId", tag: "ecommerce", method: "DELETE", path: "/ecommerce/stores/{store_id}/orders/{order_id}/lines/{line_id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public final class Request: Prch.Request<Response, MailchimpAPI> {
      ...
      public init(options: Options) {
        ...
        super.init(service: DeleteEcommerceStoresIdOrdersIdLinesId.service)
      }
