...
public extension Ecommerce {
  ...
  enum GetEcommerceStoresIdCustomersId {
    public static let service = Service<Response>(id: "getEcommerceStoresIdCustomersId", tag: "ecommerce", method: "GET", path: "/ecommerce/stores/{store_id}/customers/{customer_id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public final class Request: Prch.Request<Response, MailchimpAPI> {
      ...
      override public var path: String {
        super.path.replacingOccurrences(of: "{" + "store_id" + "}", with: "\(self.options.storeId)").replacingOccurrences(of: "{" + "customer_id" + "}", with: "\(self.options.customerId)")
      }
