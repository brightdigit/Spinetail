...
import Prch
  ...
  public extension Ecommerce {
    ...
    enum PostEcommerceStoresIdProducts {
      public static let service = Service<Response>(id: "postEcommerceStoresIdProducts", tag: "ecommerce", method: "POST", path: "/ecommerce/stores/{store_id}/products", hasBody: true, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
      ...
      public final class Request: Prch.Request<Response, MailchimpAPI> {
        ...
        public struct Body: Model {
          ...
          public init(id: String, title: String, variants: [Variants], description: String? = nil, handle: String? = nil, imageURL: String? = nil, images: [Images]? = nil, publishedAtForeign: Date? = nil, type: String? = nil, url: String? = nil, vendor: String? = nil) {
            self.id = id
            self.title = title
        ...
        public init(body: Body, options: Options, encoder: RequestEncoder? = nil) {
          ...
          super.init(service: PostEcommerceStoresIdProducts.service) { defaultEncoder in
