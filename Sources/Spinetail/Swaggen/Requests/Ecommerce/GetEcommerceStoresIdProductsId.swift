...
import Prch
  ...
  public extension Ecommerce {
    ...
    enum GetEcommerceStoresIdProductsId {
      public static let service = Service<Response>(id: "getEcommerceStoresIdProductsId", tag: "ecommerce", method: "GET", path: "/ecommerce/stores/{store_id}/products/{product_id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
