  ...
  enum PatchEcommerceStoresIdProductsIdImagesId {
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(body: Body, options: Options, encoder: RequestEncoder? = nil) {
        ...
        super.init(service: PatchEcommerceStoresIdProductsIdImagesId.service) { defaultEncoder in
      ...
      override public var path: String {
        super.path.replacingOccurrences(of: "{" + "store_id" + "}", with: "\(options.storeId)").replacingOccurrences(of: "{" + "product_id" + "}", with: "\(options.productId)").replacingOccurrences(of: "{" + "image_id" + "}", with: "\(options.imageId)")
      }
    }
