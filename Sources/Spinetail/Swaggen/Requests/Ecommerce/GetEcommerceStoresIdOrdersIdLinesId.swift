  ...
  enum GetEcommerceStoresIdOrdersIdLinesId {
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(options: Options) {
        ...
        super.init(service: GetEcommerceStoresIdOrdersIdLinesId.service)
      }
      ...
      override public var path: String {
        super.path.replacingOccurrences(of: "{" + "store_id" + "}", with: "\(self.options.storeId)").replacingOccurrences(of: "{" + "order_id" + "}", with: "\(self.options.orderId)").replacingOccurrences(of: "{" + "line_id" + "}", with: "\(self.options.lineId)")
      }
