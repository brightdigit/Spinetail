...
public extension Ecommerce {
  ...
  enum DeleteEcommerceStoresIdPromocodesId {
    public static let service = Service<Response>(id: "deleteEcommerceStoresIdPromocodesId", tag: "ecommerce", method: "DELETE", path: "/ecommerce/stores/{store_id}/promo-rules/{promo_rule_id}/promo-codes/{promo_code_id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public final class Request: Prch.Request<Response, MailchimpAPI> {
      ...
      public init(options: Options) {
        ...
        super.init(service: DeleteEcommerceStoresIdPromocodesId.service)
      }
