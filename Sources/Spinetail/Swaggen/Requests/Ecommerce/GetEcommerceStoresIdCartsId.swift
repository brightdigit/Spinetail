...
import Prch
  ...
  public extension Ecommerce {
    ...
    enum GetEcommerceStoresIdCartsId {
      public static let service = Service<Response>(id: "getEcommerceStoresIdCartsId", tag: "ecommerce", method: "GET", path: "/ecommerce/stores/{store_id}/carts/{cart_id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
