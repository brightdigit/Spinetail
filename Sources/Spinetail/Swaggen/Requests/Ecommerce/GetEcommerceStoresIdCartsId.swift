...
public extension Ecommerce {
  ...
  enum GetEcommerceStoresIdCartsId {
    public static let service = APIService<Response>(id: "getEcommerceStoresIdCartsId", tag: "ecommerce", method: "GET", path: "/ecommerce/stores/{store_id}/carts/{cart_id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(options: Options) {
        ...
        super.init(service: GetEcommerceStoresIdCartsId.service)
      }

      /// convenience initialiser so an Option doesn't have to be created
      public convenience init(fields: [String]? = nil, excludeFields: [String]? = nil, storeId: String, cartId: String) {
        let options = Options(fields: fields, excludeFields: excludeFields, storeId: storeId, cartId: cartId)
        self.init(options: options)
      }

      override public var path: String {
        super.path.replacingOccurrences(of: "{" + "store_id" + "}", with: "\(self.options.storeId)").replacingOccurrences(of: "{" + "cart_id" + "}", with: "\(self.options.cartId)")
      }
