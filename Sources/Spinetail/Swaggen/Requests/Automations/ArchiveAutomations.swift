...
public extension Automations {
  ...
  enum ArchiveAutomations {
    public static let service = Service<Response>(id: "archiveAutomations", tag: "automations", method: "POST", path: "/automations/{workflow_id}/actions/archive", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
