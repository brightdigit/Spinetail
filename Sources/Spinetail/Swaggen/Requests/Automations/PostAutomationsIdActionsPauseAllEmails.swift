...
import Prch
  ...
  public extension Automations {
    ...
    enum PostAutomationsIdActionsPauseAllEmails {
      public static let service = Service<Response>(id: "postAutomationsIdActionsPauseAllEmails", tag: "automations", method: "POST", path: "/automations/{workflow_id}/actions/pause-all-emails", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
      ...
      public final class Request: Prch.Request<Response, MailchimpAPI> {
        ...
        public init(options: Options) {
          ...
          super.init(service: PostAutomationsIdActionsPauseAllEmails.service)
        }
