  ...
  enum GetAutomationsIdRemovedSubscribersId {
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(options: Options) {
        ...
        super.init(service: GetAutomationsIdRemovedSubscribersId.service)
      }
      ...
      override public var path: String {
        super.path.replacingOccurrences(of: "{" + "workflow_id" + "}", with: "\(options.workflowId)").replacingOccurrences(of: "{" + "subscriber_hash" + "}", with: "\(options.subscriberHash)")
      }
    }
