...
public extension Automations {
  ...
  enum PostAutomationsIdEmailsIdActionsStart {
    public static let service = Service<Response>(id: "postAutomationsIdEmailsIdActionsStart", tag: "automations", method: "POST", path: "/automations/{workflow_id}/emails/{workflow_email_id}/actions/start", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
