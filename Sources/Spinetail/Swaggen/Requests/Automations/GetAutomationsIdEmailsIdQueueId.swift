...
import Prch
  ...
  public extension Automations {
    ...
    enum GetAutomationsIdEmailsIdQueueId {
      public static let service = Service<Response>(id: "getAutomationsIdEmailsIdQueueId", tag: "automations", method: "GET", path: "/automations/{workflow_id}/emails/{workflow_email_id}/queue/{subscriber_hash}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
      ...
      public final class Request: Prch.Request<Response, MailchimpAPI> {
        ...
        public init(options: Options) {
          ...
          super.init(service: GetAutomationsIdEmailsIdQueueId.service)
        }

        /// convenience initialiser so an Option doesn't have to be created
        public convenience init(workflowId: String, workflowEmailId: String, subscriberHash: String) {
          let options = Options(workflowId: workflowId, workflowEmailId: workflowEmailId, subscriberHash: subscriberHash)
          self.init(options: options)
        }

        override public var path: String {
          super.path.replacingOccurrences(of: "{" + "workflow_id" + "}", with: "\(options.workflowId)").replacingOccurrences(of: "{" + "workflow_email_id" + "}", with: "\(options.workflowEmailId)").replacingOccurrences(of: "{" + "subscriber_hash" + "}", with: "\(options.subscriberHash)")
        }
      }
