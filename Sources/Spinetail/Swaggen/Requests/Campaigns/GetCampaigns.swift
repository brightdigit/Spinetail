...
public extension Campaigns {
   ...
   */
  enum GetCampaigns {
    public static let service = Service<Response>(id: "getCampaigns", tag: "campaigns", method: "GET", path: "/campaigns", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public final class Request: Prch.Request<Response, MailchimpAPI> {
      ...
      public init(options: Options) {
        ...
        super.init(service: GetCampaigns.service)
      }
      ...
      public struct Status200: Model {
        ...
        public struct Campaigns: Model {
          ...
          public struct Recipients: Model {
            ...
            public init(listId: String? = nil, listIsActive: Bool? = nil, listName: String? = nil, recipientCount: Int? = nil, segmentOpts _: SegmentOpts? = nil, segmentText: String? = nil) {
              self.listId = listId
        ...
        public init(links: [Links]? = nil, campaigns: [Campaigns]? = nil, totalItems: Int? = nil) {
          self.links = links
