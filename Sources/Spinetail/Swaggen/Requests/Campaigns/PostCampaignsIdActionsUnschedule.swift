...
public extension Campaigns {
  ...
  enum PostCampaignsIdActionsUnschedule {
    public static let service = Service<Response>(id: "postCampaignsIdActionsUnschedule", tag: "campaigns", method: "POST", path: "/campaigns/{campaign_id}/actions/unschedule", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public final class Request: Prch.Request<Response, MailchimpAPI> {
      ...
      public init(options: Options) {
        ...
        super.init(service: PostCampaignsIdActionsUnschedule.service)
      }
