...
public extension Campaigns {
  ...
  enum DeleteCampaignsId {
    public static let service = Service<Response>(id: "deleteCampaignsId", tag: "campaigns", method: "DELETE", path: "/campaigns/{campaign_id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public final class Request: Prch.Request<Response, MailchimpAPI> {
      ...
      public init(options: Options) {
        ...
        super.init(service: DeleteCampaignsId.service)
      }
