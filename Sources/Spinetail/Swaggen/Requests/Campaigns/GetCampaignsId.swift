...
public extension Campaigns {
   ...
   */
  enum GetCampaignsId {
    public static let service = Service<Response>(id: "getCampaignsId", tag: "campaigns", method: "GET", path: "/campaigns/{campaign_id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public final class Request: Prch.Request<Response, MailchimpAPI> {
      ...
      public init(options: Options) {
        ...
        super.init(service: GetCampaignsId.service)
      }
