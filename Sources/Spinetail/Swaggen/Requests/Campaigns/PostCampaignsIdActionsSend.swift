...
public extension Campaigns {
  ...
  enum PostCampaignsIdActionsSend {
    public static let service = Service<Response>(id: "postCampaignsIdActionsSend", tag: "campaigns", method: "POST", path: "/campaigns/{campaign_id}/actions/send", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public final class Request: Prch.Request<Response, MailchimpAPI> {
      ...
      public init(options: Options) {
        ...
        super.init(service: PostCampaignsIdActionsSend.service)
      }
