...
public extension Campaigns {
  ...
  enum PatchCampaignsId {
    public static let service = Service<Response>(id: "patchCampaignsId", tag: "campaigns", method: "PATCH", path: "/campaigns/{campaign_id}", hasBody: true, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public final class Request: Prch.Request<Response, MailchimpAPI> {
      ...
      public struct Body: Model {
        ...
        public init(settings: Settings, recipients: Recipients? = nil, rssOpts: RssOpts? = nil, socialCard: SocialCard? = nil, tracking: Tracking? = nil, variateSettings: VariateSettings? = nil) {
      ...
      public init(body: Body, options: Options, encoder: RequestEncoder? = nil) {
        ...
        super.init(service: PatchCampaignsId.service) { defaultEncoder in
