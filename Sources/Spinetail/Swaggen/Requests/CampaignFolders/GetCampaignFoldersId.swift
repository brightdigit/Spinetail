...
public extension CampaignFolders {
  ...
  enum GetCampaignFoldersId {
    public static let service = Service<Response>(id: "getCampaignFoldersId", tag: "campaignFolders", method: "GET", path: "/campaign-folders/{folder_id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public final class Request: Prch.Request<Response, MailchimpAPI> {
      ...
      public init(options: Options) {
        ...
        super.init(service: GetCampaignFoldersId.service)
      }
