  ...
  enum PatchListsIdInterestCategoriesIdInterestsId {
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(body: Body, options: Options, encoder: RequestEncoder? = nil) {
        ...
        super.init(service: PatchListsIdInterestCategoriesIdInterestsId.service) { defaultEncoder in
      ...
      override public var path: String {
        super.path.replacingOccurrences(of: "{" + "list_id" + "}", with: "\(options.listId)").replacingOccurrences(of: "{" + "interest_category_id" + "}", with: "\(options.interestCategoryId)").replacingOccurrences(of: "{" + "interest_id" + "}", with: "\(options.interestId)")
      }
    }
