...
public extension Lists {
  ...
  enum GetListsIdClients {
    public static let service = Service<Response>(id: "getListsIdClients", tag: "lists", method: "GET", path: "/lists/{list_id}/clients", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public final class Request: Prch.Request<Response, MailchimpAPI> {
      ...
      public init(options: Options) {
        ...
        super.init(service: GetListsIdClients.service)
      }
    ...
    public enum Response: Prch.Response, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public struct Status200: Model {
        ...
        public init(links: [Links]? = nil, clients: [Clients]? = nil, listId: String? = nil, totalItems: Int? = nil) {
          self.links = links
