...
public extension Lists {
  ...
  enum DeleteListsIdMembersId {
    public static let service = Service<Response>(id: "deleteListsIdMembersId", tag: "lists", method: "DELETE", path: "/lists/{list_id}/members/{subscriber_hash}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public final class Request: Prch.Request<Response, MailchimpAPI> {
      ...
      public init(options: Options) {
        ...
        super.init(service: DeleteListsIdMembersId.service)
      }
