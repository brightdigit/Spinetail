...
public extension Lists {
  ...
  enum GetListsIdMembersId {
    public static let service = Service<Response>(id: "getListsIdMembersId", tag: "lists", method: "GET", path: "/lists/{list_id}/members/{subscriber_hash}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public final class Request: Prch.Request<Response, MailchimpAPI> {
      ...
      public init(options: Options) {
        ...
        super.init(service: GetListsIdMembersId.service)
      }

      /// convenience initialiser so an Option doesn't have to be created
      public convenience init(fields: [String]? = nil, excludeFields: [String]? = nil, listId: String, subscriberHash: String) {
        let options = Options(fields: fields, excludeFields: excludeFields, listId: listId, subscriberHash: subscriberHash)
