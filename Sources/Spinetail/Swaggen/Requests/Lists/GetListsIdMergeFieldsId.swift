  ...
  enum GetListsIdMergeFieldsId {
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(options: Options) {
        ...
        super.init(service: GetListsIdMergeFieldsId.service)
      }
      ...
      override public var path: String {
        super.path.replacingOccurrences(of: "{" + "list_id" + "}", with: "\(self.options.listId)").replacingOccurrences(of: "{" + "merge_id" + "}", with: "\(self.options.mergeId)")
      }
