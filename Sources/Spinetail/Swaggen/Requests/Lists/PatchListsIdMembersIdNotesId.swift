  ...
  enum PatchListsIdMembersIdNotesId {
    ...
    public final class Request: APIRequest<Response> {
      ...
      override public var path: String {
        super.path.replacingOccurrences(of: "{" + "list_id" + "}", with: "\(options.listId)").replacingOccurrences(of: "{" + "subscriber_hash" + "}", with: "\(options.subscriberHash)").replacingOccurrences(of: "{" + "note_id" + "}", with: "\(options.noteId)")
      }
    }
