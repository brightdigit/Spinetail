  ...
  enum GetListsIdMembersIdNotesId {
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(options: Options) {
        ...
        super.init(service: GetListsIdMembersIdNotesId.service)
      }
      ...
      public convenience init(listId: String, subscriberHash: String, noteId: String, fields: [String]? = nil, excludeFields: [String]? = nil) {
        let options = Options(listId: listId, subscriberHash: subscriberHash, noteId: noteId, fields: fields, excludeFields: excludeFields)
        self.init(options: options)
      }

      override public var path: String {
        super.path.replacingOccurrences(of: "{" + "list_id" + "}", with: "\(self.options.listId)").replacingOccurrences(of: "{" + "subscriber_hash" + "}", with: "\(self.options.subscriberHash)").replacingOccurrences(of: "{" + "note_id" + "}", with: "\(self.options.noteId)")
      }
