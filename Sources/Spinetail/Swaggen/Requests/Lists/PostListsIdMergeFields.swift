  ...
  enum PostListsIdMergeFields {
    ...
    public final class Request: APIRequest<Response> {
      ...
      public struct Body: Model {
        ...
        public init(name: String, type: Type, defaultValue: String? = nil, displayOrder: Int? = nil, helpText: String? = nil, options: Options? = nil, public: Bool? = nil, required: Bool? = nil, tag: String? = nil) {
          self.name = name
          self.type = type
      ...
      public init(body: Body, options: Options, encoder: RequestEncoder? = nil) {
        self.body = body
        self.options = options
        super.init(service: PostListsIdMergeFields.service) { defaultEncoder in
