...
public extension Lists {
  ...
  enum GetListsIdSignupForms {
    public static let service = Service<Response>(id: "getListsIdSignupForms", tag: "lists", method: "GET", path: "/lists/{list_id}/signup-forms", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public final class Request: Prch.Request<Response, MailchimpAPI> {
      ...
      public init(options: Options) {
        ...
        super.init(service: GetListsIdSignupForms.service)
      }
    ...
    public enum Response: Prch.Response, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public struct Status200: Model {
        ...
        /** List signup form. */
        public var signupForms: [SignupForms]?
        ...
        public init(links: [Links]? = nil, listId: String? = nil, signupForms: [SignupForms]? = nil, totalItems: Int? = nil) {
          self.links = links
          self.listId = listId
