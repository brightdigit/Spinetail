  ...
  enum GetListsIdAbuseReportsId {
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(options: Options) {
        ...
        super.init(service: GetListsIdAbuseReportsId.service)
      }
      ...
      override public var path: String {
        super.path.replacingOccurrences(of: "{" + "list_id" + "}", with: "\(self.options.listId)").replacingOccurrences(of: "{" + "report_id" + "}", with: "\(self.options.reportId)")
      }
