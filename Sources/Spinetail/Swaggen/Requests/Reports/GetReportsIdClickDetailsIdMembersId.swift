...
import Prch
  ...
  public extension Reports {
    ...
    enum GetReportsIdClickDetailsIdMembersId {
      public static let service = Service<Response>(id: "getReportsIdClickDetailsIdMembersId", tag: "reports", method: "GET", path: "/reports/{campaign_id}/click-details/{link_id}/members/{subscriber_hash}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
      ...
      public final class Request: Prch.Request<Response, MailchimpAPI> {
        ...
        public init(options: Options) {
          ...
          super.init(service: GetReportsIdClickDetailsIdMembersId.service)
        }
        ...
        public convenience init(fields: [String]? = nil, excludeFields: [String]? = nil, campaignId: String, linkId: String, subscriberHash: String) {
          let options = Options(fields: fields, excludeFields: excludeFields, campaignId: campaignId, linkId: linkId, subscriberHash: subscriberHash)
          self.init(options: options)
        }

        override public var path: String {
          super.path.replacingOccurrences(of: "{" + "campaign_id" + "}", with: "\(self.options.campaignId)").replacingOccurrences(of: "{" + "link_id" + "}", with: "\(self.options.linkId)").replacingOccurrences(of: "{" + "subscriber_hash" + "}", with: "\(self.options.subscriberHash)")
        }
      ...
      public enum Response: Prch.Response, CustomStringConvertible, CustomDebugStringConvertible {
        ...
        public struct Status200: Model {
          ...
          public init(links: [Links]? = nil, campaignId: String? = nil, clicks: Int? = nil, contactStatus: String? = nil, emailAddress: String? = nil, emailId: String? = nil, listId: String? = nil, listIsActive: Bool? = nil, mergeFields: [String: AnyCodable]? = nil, uRLId: String? = nil, vip: Bool? = nil) {
            self.links = links
            self.campaignId = campaignId
            self.clicks = clicks
