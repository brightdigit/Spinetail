...
import Prch
  ...
  public extension Reports {
    ...
    enum GetReportsIdAbuseReportsId {
      public static let service = Service<Response>(id: "getReportsIdAbuseReportsId", tag: "reports", method: "GET", path: "/reports/{campaign_id}/abuse-reports", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
