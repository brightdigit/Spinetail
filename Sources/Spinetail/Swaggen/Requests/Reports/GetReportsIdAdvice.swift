...
import Prch
  ...
  public extension Reports {
    ...
    enum GetReportsIdAdvice {
      public static let service = Service<Response>(id: "getReportsIdAdvice", tag: "reports", method: "GET", path: "/reports/{campaign_id}/advice", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
      ...
      public final class Request: Prch.Request<Response, MailchimpAPI> {
        ...
        public init(options: Options) {
          ...
          super.init(service: GetReportsIdAdvice.service)
        }
      ...
      public enum Response: Prch.Response, CustomStringConvertible, CustomDebugStringConvertible {
        ...
        public struct Status200: Model {
          ...
          public init(links: [Links]? = nil, advice: [Advice]? = nil, campaignId: String? = nil, totalItems: Int? = nil) {
            self.links = links
            self.advice = advice
            self.campaignId = campaignId
