...
public extension Reports {
  ...
  enum GetReportsIdSubReportsId {
    public static let service = Service<Response>(id: "getReportsIdSubReportsId", tag: "reports", method: "GET", path: "/reports/{campaign_id}/sub-reports", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public final class Request: Prch.Request<Response, MailchimpAPI> {
      ...
      public init(options: Options) {
        ...
        super.init(service: GetReportsIdSubReportsId.service)
      }
    ...
    public enum Response: Prch.Response, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public struct Status200: Model {
        ...
        public init(links: [Links]? = nil, campaignId: String? = nil, reports: [Reports]? = nil, totalItems: Int? = nil) {
          self.links = links
          self.campaignId = campaignId
