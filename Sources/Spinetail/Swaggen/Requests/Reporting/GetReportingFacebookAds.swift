...
import Prch
  ...
  public extension Reporting {
    ...
    enum GetReportingFacebookAds {
      public static let service = Service<Response>(id: "getReportingFacebookAds", tag: "reporting", method: "GET", path: "/reporting/facebook-ads", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
      ...
      public final class Request: Prch.Request<Response, MailchimpAPI> {
        ...
        public init(options: Options) {
          ...
          super.init(service: GetReportingFacebookAds.service)
        }
