...
import Prch
    ...
    public extension Reporting {
      ...
      enum GetReportingFacebookAdsIdEcommerceProductActivity {
        public static let service = Service<Response>(id: "getReportingFacebookAdsIdEcommerceProductActivity", tag: "reporting", method: "GET", path: "/reporting/facebook-ads/{outreach_id}/ecommerce-product-activity", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
        ...
        public struct Request: ServiceRequest {
          ...
          public var service: Service<Response> {
            GetReportingFacebookAdsIdEcommerceProductActivity.service
          }
          ...
          public var path: String {
            service.path.replacingOccurrences(of: "{" + "outreach_id" + "}", with: "\(options.outreachId)")
          }
