...
public struct ECommercePromoRule2: Codable, Equatable, Content {
  ...
  public init(amount: Float? = nil, createdAtForeign: MailchimpOptionalDate = nil, description: String? = nil, enabled: Bool? = nil, endsAt: String? = nil, startsAt: MailchimpOptionalDate = nil, target: Target? = nil, title: String? = nil, type: Type? = nil, updatedAtForeign: MailchimpOptionalDate = nil) {
    self.amount = amount
