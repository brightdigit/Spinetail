...
public struct CampaignTrackingOptions1Model: Codable, Equatable, Content {
  public var capsule: CapsuleCRMTracking2Model?
  ...
  public var salesforce: SalesforceCRMTracking1Model?
  ...
  public init(capsule: CapsuleCRMTracking2Model? = nil, clicktale: String? = nil, ecomm360: Bool? = nil, goalTracking: Bool? = nil, googleAnalytics: String? = nil, htmlClicks: Bool? = nil, opens: Bool? = nil, salesforce: SalesforceCRMTracking1Model? = nil, textClicks: Bool? = nil) {
