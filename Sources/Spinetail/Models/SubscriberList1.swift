...
public struct SubscriberList1: Codable, Equatable, Content {
  public let campaignDefaults: CampaignDefaults1

  public let contact: ListContact1
  ...
  public init(campaignDefaults: CampaignDefaults1, contact: ListContact1, emailTypeOption: Bool, name: String, permissionReminder: String, doubleOptin: Bool? = nil, marketingPermissions: Bool? = nil, notifyOnSubscribe: String? = nil, notifyOnUnsubscribe: String? = nil, useArchiveBar: Bool? = nil) {
