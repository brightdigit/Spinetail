...
public struct ABTestOptions2Model: Codable, Equatable, Content {
  ...
  public init(winnerCriteria: WinnerCriteria, combinations: [CombinationsInnerModel]? = nil, contents: [String]? = nil, fromNames: [String]? = nil, replyToAddresses: [String]? = nil, sendTimes: [DateTime]? = nil, subjectLines: [String]? = nil, testSize: Int? = nil, waitTime: Int? = nil, winningCampaignId: String? = nil, winningCombinationId: String? = nil) {
