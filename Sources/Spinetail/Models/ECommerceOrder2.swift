...
public struct ECommerceOrder2: Codable, Equatable, Content {
  ...
  public init(billingAddress: BillingAddress? = nil, campaignId: String? = nil, cancelledAtForeign: MailchimpOptionalDate = nil, currencyCode: String? = nil, customer: ECommerceCustomer2? = nil, discountTotal: Double? = nil, financialStatus: String? = nil, fulfillmentStatus: String? = nil, landingSite: String? = nil, lines: [ECommerceOrderLineItem2]? = nil, orderTotal: Double? = nil, orderURL: String? = nil, outreach: Outreach1? = nil, processedAtForeign: MailchimpOptionalDate = nil, promos: [PromosInner1]? = nil, shippingAddress: ShippingAddress? = nil, shippingTotal: Double? = nil, taxTotal: Double? = nil, trackingCarrier: String? = nil, trackingCode: TrackingCode? = nil, trackingNumber: String? = nil, trackingURL: String? = nil, updatedAtForeign: MailchimpOptionalDate = nil) {
