...
public struct AddListMembers2Model: Codable, Equatable, Content {
  ...
  public init(emailAddress: String, statusIfNew: StatusIfNew, emailType: String? = nil, interests: [String: Bool]? = nil, ipOpt: String? = nil, ipSignup: String? = nil, language: String? = nil, location: LocationModel? = nil, marketingPermissions: [MarketingPermission1Model]? = nil, mergeFields: [String: String]? = nil, status: Status? = nil, timestampOpt: DateTime? = nil, timestampSignup: DateTime? = nil, vip: Bool? = nil) {
