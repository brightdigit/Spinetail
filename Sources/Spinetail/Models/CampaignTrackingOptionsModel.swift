...
public struct CampaignTrackingOptionsModel: Codable, Equatable, Content {
  public var capsule: CapsuleCRMTracking1Model?
  ...
  public init(capsule: CapsuleCRMTracking1Model? = nil, clicktale: String? = nil, ecomm360: Bool? = nil, goalTracking: Bool? = nil, googleAnalytics: String? = nil, htmlClicks: Bool? = nil, opens: Bool? = nil, salesforce: SalesforceCRMTrackingModel? = nil, textClicks: Bool? = nil) {
