...
import Prch
  ...
  public extension LandingPages {
    ...
    enum PatchLandingPageId {
      public static let service = Service<Response>(id: "patchLandingPageId", tag: "landingPages", method: "PATCH", path: "/landing-pages/{page_id}", hasBody: true, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
      ...
      public struct Request: ServiceRequest {
        ...
        public struct Body: Model {
          ...
          public init(description: String? = nil, listId: String? = nil, name: String? = nil, storeId: String? = nil, title: String? = nil, tracking: Tracking? = nil) {
        ...
        public var service: Service<Response> {
          PatchLandingPageId.service
        }

        /// convenience initialiser so an Option doesn't have to be created
        public init(pageId: String, body: Body) {
      ...
      public enum Response: Prch.DeprecatedResponse, CustomStringConvertible, CustomDebugStringConvertible {
