...
import Prch
  ...
  public extension Automations {
    ...
    enum PostAutomations {
      public static let service = Service<Response>(id: "postAutomations", tag: "automations", method: "POST", path: "/automations", hasBody: true, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
