...
import Prch
  ...
  public extension Automations {
    ...
    enum GetAutomationsIdEmails {
      public static let service = Service<Response>(id: "getAutomationsIdEmails", tag: "automations", method: "GET", path: "/automations/{workflow_id}/emails", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
      ...
      public struct Request: ServiceRequest {
        ...
        public var service: Service<Response> {
          GetAutomationsIdEmails.service
        }
