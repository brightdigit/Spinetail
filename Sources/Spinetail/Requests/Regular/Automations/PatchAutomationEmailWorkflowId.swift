...
import Prch
  ...
  public extension Automations {
    ...
    enum PatchAutomationEmailWorkflowId {
      public static let service = Service<Response>(id: "patchAutomationEmailWorkflowId", tag: "automations", method: "PATCH", path: "/automations/{workflow_id}/emails/{workflow_email_id}", hasBody: true, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
      ...
      public struct Request: ServiceRequest {
        ...
        public var service: Service<Response> {
          PatchAutomationEmailWorkflowId.service
        }
