    ...
    enum GetAutomationsIdEmailsIdQueueId {
      ...
      public struct Request: ServiceRequest {
        ...
        public var service: Service<Response> {
          GetAutomationsIdEmailsIdQueueId.service
        }
        ...
        public var path: String {
          service.path.replacingOccurrences(of: "{" + "workflow_id" + "}", with: "\(options.workflowId)").replacingOccurrences(of: "{" + "workflow_email_id" + "}", with: "\(options.workflowEmailId)").replacingOccurrences(of: "{" + "subscriber_hash" + "}", with: "\(options.subscriberHash)")
        }
      }
