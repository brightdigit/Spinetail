...
import Prch
  ...
  public extension AuthorizedApps {
    ...
    enum GetAuthorizedApps {
      public static let service = Service<Response>(id: "getAuthorizedApps", tag: "authorizedApps", method: "GET", path: "/authorized-apps", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
