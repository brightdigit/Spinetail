...
import Prch
    ...
    public extension Ecommerce {
      ...
      enum PostEcommerceStores {
        public static let service = Service<Response>(id: "postEcommerceStores", tag: "ecommerce", method: "POST", path: "/ecommerce/stores", hasBody: true, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
