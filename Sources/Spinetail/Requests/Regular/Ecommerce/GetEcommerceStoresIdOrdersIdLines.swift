...
import Prch
    ...
    public extension Ecommerce {
      ...
      enum GetEcommerceStoresIdOrdersIdLines {
        public static let service = Service<Response>(id: "getEcommerceStoresIdOrdersIdLines", tag: "ecommerce", method: "GET", path: "/ecommerce/stores/{store_id}/orders/{order_id}/lines", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
        ...
        public struct Request: ServiceRequest {
          ...
          public var service: Service<Response> {
            GetEcommerceStoresIdOrdersIdLines.service
          }
