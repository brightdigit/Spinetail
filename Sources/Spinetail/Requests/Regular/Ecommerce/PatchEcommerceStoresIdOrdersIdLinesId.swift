...
import Prch
    ...
    public extension Ecommerce {
      ...
      enum PatchEcommerceStoresIdOrdersIdLinesId {
        public static let service = Service<Response>(id: "patchEcommerceStoresIdOrdersIdLinesId", tag: "ecommerce", method: "PATCH", path: "/ecommerce/stores/{store_id}/orders/{order_id}/lines/{line_id}", hasBody: true, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
        ...
        public struct Request: ServiceRequest {
          ...
          public var service: Service<Response> {
            PatchEcommerceStoresIdOrdersIdLinesId.service
          }

          /// convenience initialiser so an Option doesn't have to be created
          public init(storeId: String, orderId: String, lineId: String, body: Body) {
