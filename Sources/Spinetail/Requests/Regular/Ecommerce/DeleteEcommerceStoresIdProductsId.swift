...
import Prch
    ...
    public extension Ecommerce {
      ...
      enum DeleteEcommerceStoresIdProductsId {
        public static let service = Service<Response>(id: "deleteEcommerceStoresIdProductsId", tag: "ecommerce", method: "DELETE", path: "/ecommerce/stores/{store_id}/products/{product_id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
        ...
        public struct Request: ServiceRequest {
          ...
          public var service: Service<Response> {
            DeleteEcommerceStoresIdProductsId.service
          }
