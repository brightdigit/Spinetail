...
import Prch
    ...
    public extension Ecommerce {
      ...
      enum GetEcommerceStoresIdOrdersId {
        public static let service = Service<Response>(id: "getEcommerceStoresIdOrdersId", tag: "ecommerce", method: "GET", path: "/ecommerce/stores/{store_id}/orders/{order_id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
        ...
        public struct Request: ServiceRequest {
          ...
          public var service: Service<Response> {
            GetEcommerceStoresIdOrdersId.service
          }
