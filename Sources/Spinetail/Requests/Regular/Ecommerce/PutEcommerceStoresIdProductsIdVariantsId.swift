...
import Prch
    ...
    public extension Ecommerce {
      ...
      enum PutEcommerceStoresIdProductsIdVariantsId {
        public static let service = Service<Response>(id: "putEcommerceStoresIdProductsIdVariantsId", tag: "ecommerce", method: "PUT", path: "/ecommerce/stores/{store_id}/products/{product_id}/variants/{variant_id}", hasBody: true, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
        ...
        public struct Request: ServiceRequest {
          ...
          public var service: Service<Response> {
            PutEcommerceStoresIdProductsIdVariantsId.service
          }
