...
import Prch
    ...
    public extension Ecommerce {
      ...
      enum PostEcommerceStoresIdProductsIdImages {
        public static let service = Service<Response>(id: "postEcommerceStoresIdProductsIdImages", tag: "ecommerce", method: "POST", path: "/ecommerce/stores/{store_id}/products/{product_id}/images", hasBody: true, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
        ...
        public struct Request: ServiceRequest {
          ...
          public var service: Service<Response> {
            PostEcommerceStoresIdProductsIdImages.service
          }
