...
import Prch
    ...
    public extension Ecommerce {
      ...
      enum GetEcommerceStoresIdPromocodesId {
        public static let service = Service<Response>(id: "getEcommerceStoresIdPromocodesId", tag: "ecommerce", method: "GET", path: "/ecommerce/stores/{store_id}/promo-rules/{promo_rule_id}/promo-codes/{promo_code_id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
        ...
        public struct Request: ServiceRequest {
          ...
          public var service: Service<Response> {
            GetEcommerceStoresIdPromocodesId.service
          }
