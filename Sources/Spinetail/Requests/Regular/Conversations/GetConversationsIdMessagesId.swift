    ...
    enum GetConversationsIdMessagesId {
      ...
      public struct Request: ServiceRequest {
        ...
        public var service: Service<Response> {
          GetConversationsIdMessagesId.service
        }
        ...
        public var path: String {
          service.path.replacingOccurrences(of: "{" + "conversation_id" + "}", with: "\(options.conversationId)").replacingOccurrences(of: "{" + "message_id" + "}", with: "\(options.messageId)")
        }
