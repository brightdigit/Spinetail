...
import Prch
  ...
  public extension Reports {
     ...
     */
    enum GetReports {
      public static let service = Service<Response>(id: "getReports", tag: "reports", method: "GET", path: "/reports", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
