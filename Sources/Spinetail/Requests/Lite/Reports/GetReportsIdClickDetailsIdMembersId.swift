    ...
    enum GetReportsIdClickDetailsIdMembersId {
      ...
      public struct Request: ServiceRequest {
        ...
        public var service: Service<Response> {
          GetReportsIdClickDetailsIdMembersId.service
        }
        ...
        public var path: String {
          service.path.replacingOccurrences(of: "{" + "campaign_id" + "}", with: "\(options.campaignId)").replacingOccurrences(of: "{" + "link_id" + "}", with: "\(options.linkId)").replacingOccurrences(of: "{" + "subscriber_hash" + "}", with: "\(options.subscriberHash)")
        }
