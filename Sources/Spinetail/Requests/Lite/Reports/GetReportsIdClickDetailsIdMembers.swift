...
import Prch
  ...
  public extension Reports {
    ...
    enum GetReportsIdClickDetailsIdMembers {
      public static let service = Service<Response>(id: "getReportsIdClickDetailsIdMembers", tag: "reports", method: "GET", path: "/reports/{campaign_id}/click-details/{link_id}/members", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
      ...
      public struct Request: ServiceRequest {
        ...
        public var service: Service<Response> {
          GetReportsIdClickDetailsIdMembers.service
        }
        ...
        public var path: String {
          service.path.replacingOccurrences(of: "{" + "campaign_id" + "}", with: "\(options.campaignId)").replacingOccurrences(of: "{" + "link_id" + "}", with: "\(options.linkId)")
        }
