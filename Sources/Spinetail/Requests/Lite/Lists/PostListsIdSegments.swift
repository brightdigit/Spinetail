...
public extension Lists {
  ...
  enum PostListsIdSegments {
    public static let service = Service<Response>(id: "postListsIdSegments", tag: "lists", method: "POST", path: "/lists/{list_id}/segments", hasBody: true, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
