...
public extension Lists {
  ...
  enum GetListsIdLocations {
    public static let service = Service<Response>(id: "getListsIdLocations", tag: "lists", method: "GET", path: "/lists/{list_id}/locations", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
