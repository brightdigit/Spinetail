...
public extension Lists {
  ...
  enum GetListsIdAbuseReports {
    public static let service = Service<Response>(id: "getListsIdAbuseReports", tag: "lists", method: "GET", path: "/lists/{list_id}/abuse-reports", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public struct Request: ServiceRequest {
      ...
      public var service: Service<Response> {
        GetListsIdAbuseReports.service
      }
