...
public extension Lists {
  ...
  enum PostListsIdMembersIdNotes {
    public static let service = Service<Response>(id: "postListsIdMembersIdNotes", tag: "lists", method: "POST", path: "/lists/{list_id}/members/{subscriber_hash}/notes", hasBody: true, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public struct Request: BodyRequest {
      ...
      public var service: Service<Response> {
        PostListsIdMembersIdNotes.service
      }
