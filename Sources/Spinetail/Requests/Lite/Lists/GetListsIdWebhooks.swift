...
public extension Lists {
  ...
  enum GetListsIdWebhooks {
    public static let service = Service<Response>(id: "getListsIdWebhooks", tag: "lists", method: "GET", path: "/lists/{list_id}/webhooks", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
