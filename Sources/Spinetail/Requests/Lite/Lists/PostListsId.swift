...
public extension Lists {
   ...
   */
  enum PostListsId {
    public static let service = Service<Response>(id: "postListsId", tag: "lists", method: "POST", path: "/lists/{list_id}", hasBody: true, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public struct Request: BodyRequest {
      ...
      public struct Body: Model {
        ...
        public struct Members: Model {
          ...
          public init(emailAddress: String? = nil, emailType: String? = nil, interests: [String: Bool]? = nil, ipOpt: String? = nil, ipSignup: String? = nil, language: String? = nil, location: Location? = nil, mergeFields: [String: AnyCodable]? = nil, status: Status? = nil, timestampOpt: Date? = nil, timestampSignup: Date? = nil, vip: Bool? = nil) {
      ...
      public init(listId: String, skipMergeValidation: Bool? = nil, skipDuplicateCheck: Bool? = nil, body: Body) {
