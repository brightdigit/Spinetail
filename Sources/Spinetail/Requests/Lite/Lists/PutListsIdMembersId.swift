...
public extension Lists {
  ...
  enum PutListsIdMembersId {
    public static let service = Service<Response>(id: "putListsIdMembersId", tag: "lists", method: "PUT", path: "/lists/{list_id}/members/{subscriber_hash}", hasBody: true, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
