...
public extension Lists {
  ...
  enum PostListMemberEvents {
    public static let service = Service<Response>(id: "postListMemberEvents", tag: "lists", method: "POST", path: "/lists/{list_id}/members/{subscriber_hash}/events", hasBody: true, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
