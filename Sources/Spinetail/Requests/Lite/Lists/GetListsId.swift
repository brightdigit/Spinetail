...
public extension Lists {
   ...
   */
  enum GetListsId {
    public static let service = Service<Response>(id: "getListsId", tag: "lists", method: "GET", path: "/lists/{list_id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
