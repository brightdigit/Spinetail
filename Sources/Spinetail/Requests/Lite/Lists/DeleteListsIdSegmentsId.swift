...
public extension Lists {
  ...
  enum DeleteListsIdSegmentsId {
    public static let service = Service<Response>(id: "deleteListsIdSegmentsId", tag: "lists", method: "DELETE", path: "/lists/{list_id}/segments/{segment_id}", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public struct Request: ServiceRequest {
      ...
      public var service: Service<Response> {
        DeleteListsIdSegmentsId.service
      }
