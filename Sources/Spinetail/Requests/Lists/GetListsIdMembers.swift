...
public extension Lists {
  ...
  enum GetListsIdMembers {
    public static let service = Service<Response>(id: "getListsIdMembers", tag: "lists", method: "GET", path: "/lists/{list_id}/members", hasBody: false, securityRequirements: [SecurityRequirement(type: "basicAuth", scopes: [])])
    ...
    public enum Response: DeprecatedResponse, CustomStringConvertible, CustomDebugStringConvertible {
      ...
      public struct Status200: Model {
        ...
        public struct Members: Model {
          ...
          public var mergeFields: AnyCodable?
