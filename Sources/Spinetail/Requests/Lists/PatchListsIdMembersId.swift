...
public extension Lists {
  ...
  struct PatchListsIdMembersId: ServiceCall {
    ...
    public init(body: AddListMembers3, listId: String, subscriberHash: String, skipMergeValidation: Bool? = nil) {
      self.body = body
      self.listId = listId
    ...
    public typealias BodyType = AddListMembers3

    public let body: AddListMembers3
  }
}
