...
open class FileManagerAPI {
    ...
    open class func deleteFileManagerFilesId(fileId: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        deleteFileManagerFilesIdWithRequestBuilder(fileId: fileId).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
    ...
    open class func deleteFileManagerFoldersId(folderId: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        deleteFileManagerFoldersIdWithRequestBuilder(folderId: folderId).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
                completion(nil, error)
