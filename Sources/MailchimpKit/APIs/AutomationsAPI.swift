...
open class AutomationsAPI {
    ...
    open class func archiveAutomations(workflowId: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        archiveAutomationsWithRequestBuilder(workflowId: workflowId).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
    ...
    open class func deleteAutomationsIdEmailsId(workflowId: String, workflowEmailId: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        deleteAutomationsIdEmailsIdWithRequestBuilder(workflowId: workflowId, workflowEmailId: workflowEmailId).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
                completion(nil, error)
  ...
  "report_summary" : {
    ...
    open class func postAutomationsIdActionsPauseAllEmails(workflowId: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        postAutomationsIdActionsPauseAllEmailsWithRequestBuilder(workflowId: workflowId).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
                completion(nil, error)
    ...
    open class func postAutomationsIdActionsStartAllEmails(workflowId: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        postAutomationsIdActionsStartAllEmailsWithRequestBuilder(workflowId: workflowId).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
                completion(nil, error)
    ...
    open class func postAutomationsIdEmailsIdActionsPause(workflowId: String, workflowEmailId: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        postAutomationsIdEmailsIdActionsPauseWithRequestBuilder(workflowId: workflowId, workflowEmailId: workflowEmailId).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
                completion(nil, error)
    ...
    open class func postAutomationsIdEmailsIdActionsStart(workflowId: String, workflowEmailId: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        postAutomationsIdEmailsIdActionsStartWithRequestBuilder(workflowId: workflowId, workflowEmailId: workflowEmailId).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
                completion(nil, error)
