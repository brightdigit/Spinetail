...
open class CampaignsAPI {
    ...
    open class func deleteCampaignsId(campaignId: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        deleteCampaignsIdWithRequestBuilder(campaignId: campaignId).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
    ...
    open class func deleteCampaignsIdFeedbackId(campaignId: String, feedbackId: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        deleteCampaignsIdFeedbackIdWithRequestBuilder(campaignId: campaignId, feedbackId: feedbackId).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
                completion(nil, error)
  ...
  "report_summary" : {
    ...
    open class func postCampaignsIdActionsCancelSend(campaignId: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        postCampaignsIdActionsCancelSendWithRequestBuilder(campaignId: campaignId).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
                completion(nil, error)
  ...
  "report_summary" : {
    ...
    open class func postCampaignsIdActionsPause(campaignId: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        postCampaignsIdActionsPauseWithRequestBuilder(campaignId: campaignId).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
                completion(nil, error)
  ...
  "report_summary" : {
    ...
    open class func postCampaignsIdActionsResume(campaignId: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        postCampaignsIdActionsResumeWithRequestBuilder(campaignId: campaignId).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
                completion(nil, error)
    ...
    open class func postCampaignsIdActionsSchedule(body: ActionsScheduleBody, campaignId: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        postCampaignsIdActionsScheduleWithRequestBuilder(body: body, campaignId: campaignId).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
                completion(nil, error)
    ...
    open class func postCampaignsIdActionsSend(campaignId: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        postCampaignsIdActionsSendWithRequestBuilder(campaignId: campaignId).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
                completion(nil, error)
    ...
    open class func postCampaignsIdActionsTest(body: ActionsTestBody, campaignId: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        postCampaignsIdActionsTestWithRequestBuilder(body: body, campaignId: campaignId).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
                completion(nil, error)
    ...
    open class func postCampaignsIdActionsUnschedule(campaignId: String, completion: @escaping ((_ data: Void?,_ error: Error?) -> Void)) {
        postCampaignsIdActionsUnscheduleWithRequestBuilder(campaignId: campaignId).execute { (response, error) -> Void in
            if error == nil {
                completion((), error)
            } else {
                completion(nil, error)
