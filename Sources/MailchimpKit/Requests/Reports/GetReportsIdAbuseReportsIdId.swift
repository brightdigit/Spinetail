...
extension API.Reports {
    ...
    */
    public enum GetReportsIdAbuseReportsIdId {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "campaign_id" + "}", with: "\(self.options.campaignId)").replacingOccurrences(of: "{" + "report_id" + "}", with: "\(self.options.reportId)")
            }
