...
extension API.Reports {
    ...
    */
    public enum GetReportsIdAbuseReportsId {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public class Status200: APIModel {
                ...
                public class AbuseReports: APIModel {
                    ...
                    public init(links: [Links]? = nil, campaignId: String? = nil, date: DateTime? = nil, emailAddress: String? = nil, emailId: String? = nil, id: Int? = nil, listId: String? = nil, listIsActive: Bool? = nil, mergeFields: [String: [String: Any]]? = nil, vip: Bool? = nil) {
                        self.links = links
                        self.campaignId = campaignId
                        self.date = date
                    ...
                    public func isEqual(to object: Any?) -> Bool {
                      guard let object = object as? AbuseReports else { return false }
                    ...
                    public static func == (lhs: AbuseReports, rhs: AbuseReports) -> Bool {
                        return lhs.isEqual(to: rhs)
                    }
                }
