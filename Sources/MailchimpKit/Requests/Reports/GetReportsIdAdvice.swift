...
extension API.Reports {
    ...
    */
    public enum GetReportsIdAdvice {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public class Status200: APIModel {
                ...
                public class Advice: APIModel {
                    ...
                    public func isEqual(to object: Any?) -> Bool {
                      guard let object = object as? Advice else { return false }
                    ...
                    public static func == (lhs: Advice, rhs: Advice) -> Bool {
                        return lhs.isEqual(to: rhs)
                    }
                }
                ...
                public func isEqual(to object: Any?) -> Bool {
                  ...
                  guard self.links == object.links else { return false }
                  guard self.advice == object.advice else { return false }
