...
extension API.Reports {
    ...
    */
    public enum GetReportsIdEcommerceProductActivity {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public class Status200: APIModel {
                ...
                /** A collection of ecommerce products. */
                public class Products: APIModel {
                    ...
                    public func isEqual(to object: Any?) -> Bool {
                      guard let object = object as? Products else { return false }
                      guard self.currencyCode == object.currencyCode else { return false }
                      guard self.imageURL == object.imageURL else { return false }
                      guard self.recommendationPurchased == object.recommendationPurchased else { return false }
                      guard self.recommendationTotal == object.recommendationTotal else { return false }
                      guard self.sku == object.sku else { return false }
                      guard self.title == object.title else { return false }
                      guard self.totalPurchased == object.totalPurchased else { return false }
