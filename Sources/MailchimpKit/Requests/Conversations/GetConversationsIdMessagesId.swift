...
extension API.Conversations {
    ...
    */
    public enum GetConversationsIdMessagesId {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "conversation_id" + "}", with: "\(self.options.conversationId)").replacingOccurrences(of: "{" + "message_id" + "}", with: "\(self.options.messageId)")
            }
