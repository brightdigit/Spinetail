...
extension API.Lists {
    ...
    */
    public enum GetListsIdGrowthHistoryId {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "list_id" + "}", with: "\(self.options.listId)").replacingOccurrences(of: "{" + "month" + "}", with: "\(self.options.month)")
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public class Status200: APIModel {
                ...
                public func isEqual(to object: Any?) -> Bool {
                  ...
                  guard self.existing == object.existing else { return false }
                  guard self.imports == object.imports else { return false }
                  guard self.listId == object.listId else { return false }
                  guard self.month == object.month else { return false }
                  guard self.optins == object.optins else { return false }
                  guard self.pending == object.pending else { return false }
                  guard self.reconfirm == object.reconfirm else { return false }
                  guard self.subscribed == object.subscribed else { return false }
                  guard self.transactional == object.transactional else { return false }
