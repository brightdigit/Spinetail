...
extension API.Lists {
    ...
    */
    public enum GetListsIdMembersIdGoals {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public class Status200: APIModel {
                ...
                public class Goals: APIModel {
                    ...
                    public func isEqual(to object: Any?) -> Bool {
                      guard let object = object as? Goals else { return false }
                      guard self.data == object.data else { return false }
                      guard self.event == object.event else { return false }
                      guard self.goalId == object.goalId else { return false }
                      guard self.lastVisitedAt == object.lastVisitedAt else { return false }
                      return true
                    }
                ...
                public func isEqual(to object: Any?) -> Bool {
                  ...
                  guard self.goals == object.goals else { return false }
