...
extension API.Lists {
    ...
    */
    public enum GetListsIdAbuseReportsId {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "list_id" + "}", with: "\(self.options.listId)").replacingOccurrences(of: "{" + "report_id" + "}", with: "\(self.options.reportId)")
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public class Status200: APIModel {
                ...
                public init(links: [Links]? = nil, campaignId: String? = nil, date: String? = nil, emailAddress: String? = nil, emailId: String? = nil, id: Int? = nil, listId: String? = nil, mergeFields: [String: [String: Any]]? = nil, vip: Bool? = nil) {
                    self.links = links
