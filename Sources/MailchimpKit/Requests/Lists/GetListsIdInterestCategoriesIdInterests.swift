...
extension API.Lists {
    ...
    */
    public enum GetListsIdInterestCategoriesIdInterests {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "list_id" + "}", with: "\(self.options.listId)").replacingOccurrences(of: "{" + "interest_category_id" + "}", with: "\(self.options.interestCategoryId)")
            }
            ...
            public class Status200: APIModel {
                ...
                public class Interests: APIModel {
                    ...
                    public func isEqual(to object: Any?) -> Bool {
                      ...
                      guard self.subscriberCount == object.subscriberCount else { return false }
                      return true
                    }
