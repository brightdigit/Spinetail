...
extension API.Lists {
    ...
    */
    public enum PatchListsIdInterestCategoriesIdInterestsId {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "list_id" + "}", with: "\(self.options.listId)").replacingOccurrences(of: "{" + "interest_category_id" + "}", with: "\(self.options.interestCategoryId)").replacingOccurrences(of: "{" + "interest_id" + "}", with: "\(self.options.interestId)")
            }
        }
