...
extension API.Lists {
    ...
    */
    public enum GetListsIdMergeFieldsId {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "list_id" + "}", with: "\(self.options.listId)").replacingOccurrences(of: "{" + "merge_id" + "}", with: "\(self.options.mergeId)")
            }
