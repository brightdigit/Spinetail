...
extension API.Ecommerce {
    ...
    Update a promo code.
    */
    public enum PatchEcommerceStoresIdPromocodesId {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "store_id" + "}", with: "\(self.options.storeId)").replacingOccurrences(of: "{" + "promo_rule_id" + "}", with: "\(self.options.promoRuleId)").replacingOccurrences(of: "{" + "promo_code_id" + "}", with: "\(self.options.promoCodeId)")
            }
        }
