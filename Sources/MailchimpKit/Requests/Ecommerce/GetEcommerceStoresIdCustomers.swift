...
extension API.Ecommerce {
    ...
    */
    public enum GetEcommerceStoresIdCustomers {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public class Status200: APIModel {
                ...
                public class Customers: APIModel {
                    ...
                    public func isEqual(to object: Any?) -> Bool {
                      guard let object = object as? Customers else { return false }
                    ...
                    public static func == (lhs: Customers, rhs: Customers) -> Bool {
                        return lhs.isEqual(to: rhs)
                    }
                }
