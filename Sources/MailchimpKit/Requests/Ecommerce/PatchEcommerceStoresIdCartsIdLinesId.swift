...
extension API.Ecommerce {
    ...
    */
    public enum PatchEcommerceStoresIdCartsIdLinesId {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "store_id" + "}", with: "\(self.options.storeId)").replacingOccurrences(of: "{" + "cart_id" + "}", with: "\(self.options.cartId)").replacingOccurrences(of: "{" + "line_id" + "}", with: "\(self.options.lineId)")
            }
        }
