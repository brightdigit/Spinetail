...
extension API.Ecommerce {
    ...
    */
    public enum GetEcommerceStoresIdProductsIdVariantsId {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "store_id" + "}", with: "\(self.options.storeId)").replacingOccurrences(of: "{" + "product_id" + "}", with: "\(self.options.productId)").replacingOccurrences(of: "{" + "variant_id" + "}", with: "\(self.options.variantId)")
            }
