...
extension API.Ecommerce {
    ...
    */
    public enum GetEcommerceStoresIdCartsId {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "store_id" + "}", with: "\(self.options.storeId)").replacingOccurrences(of: "{" + "cart_id" + "}", with: "\(self.options.cartId)")
            }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public class Status200: APIModel {
                ...
                public func isEqual(to object: Any?) -> Bool {
                  ...
                  guard self.checkoutURL == object.checkoutURL else { return false }
                  guard self.createdAt == object.createdAt else { return false }
