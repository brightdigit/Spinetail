...
extension MailchimpKit.ConnectedSites {
    ...
    */
    public enum PostConnectedSitesIdActionsVerifyScriptInstallation {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: PostConnectedSitesIdActionsVerifyScriptInstallation.service)
            }
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "connected_site_id" + "}", with: "\(self.options.connectedSiteId)")
            }
        }
