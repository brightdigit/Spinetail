    ...
    public enum PatchTemplatesId {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "template_id" + "}", with: "\(self.options.templateId)")
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public class Status200: APIModel {
                ...
                public func isEqual(to object: Any?) -> Bool {
                  ...
                  guard self.dateEdited == object.dateEdited else { return false }
                  guard self.dragAndDrop == object.dragAndDrop else { return false }
                  guard self.editedBy == object.editedBy else { return false }
                  guard self.folderId == object.folderId else { return false }
                  guard self.id == object.id else { return false }
                  guard self.name == object.name else { return false }
                  guard self.responsive == object.responsive else { return false }
