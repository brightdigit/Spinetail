...
extension API.Campaigns {
    ...
    Send a test email.
    */
    public enum PostCampaignsIdActionsTest {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public class Body: APIModel {
                ...
                public func isEqual(to object: Any?) -> Bool {
                  ...
                  guard self.sendType == object.sendType else { return false }
                  guard self.testEmails == object.testEmails else { return false }
                  return true
                }
            ...
            public init(body: Body, options: Options, encoder: RequestEncoder? = nil) {
                ...
                super.init(service: PostCampaignsIdActionsTest.service) { defaultEncoder in
