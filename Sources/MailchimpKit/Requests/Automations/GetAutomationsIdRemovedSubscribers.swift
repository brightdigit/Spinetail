...
extension API.Automations {
    ...
    */
    public enum GetAutomationsIdRemovedSubscribers {
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public class Status200: APIModel {
                ...
                public class Subscribers: APIModel {
                    ...
                    public func isEqual(to object: Any?) -> Bool {
                      guard let object = object as? Subscribers else { return false }
                    ...
                    public static func == (lhs: Subscribers, rhs: Subscribers) -> Bool {
                        return lhs.isEqual(to: rhs)
                    }
                }
                ...
                public func isEqual(to object: Any?) -> Bool {
                  ...
                  guard self.links == object.links else { return false }
                  guard self.subscribers == object.subscribers else { return false }
