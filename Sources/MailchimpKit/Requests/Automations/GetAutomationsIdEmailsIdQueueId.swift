...
extension API.Automations {
    ...
    */
    public enum GetAutomationsIdEmailsIdQueueId {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "workflow_id" + "}", with: "\(self.options.workflowId)").replacingOccurrences(of: "{" + "workflow_email_id" + "}", with: "\(self.options.workflowEmailId)").replacingOccurrences(of: "{" + "subscriber_hash" + "}", with: "\(self.options.subscriberHash)")
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public class Status200: APIModel {
                ...
                public func isEqual(to object: Any?) -> Bool {
                  ...
                  guard self.nextSend == object.nextSend else { return false }
