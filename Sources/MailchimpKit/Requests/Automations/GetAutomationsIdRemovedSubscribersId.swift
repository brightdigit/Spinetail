...
extension API.Automations {
    ...
    */
    public enum GetAutomationsIdRemovedSubscribersId {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "workflow_id" + "}", with: "\(self.options.workflowId)").replacingOccurrences(of: "{" + "subscriber_hash" + "}", with: "\(self.options.subscriberHash)")
            }
        }
