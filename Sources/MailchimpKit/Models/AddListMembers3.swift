...
public struct AddListMembers3: Codable {
    ...
    public init(emailAddress: String? = nil, emailType: String? = nil, status: Status? = nil, mergeFields: [String:Any]? = nil, interests: [String:Bool]? = nil, language: String? = nil, vip: Bool? = nil, location: Location? = nil, marketingPermissions: [MarketingPermission]? = nil, ipSignup: String? = nil, timestampSignup: Date? = nil, ipOpt: String? = nil, timestampOpt: Date? = nil) {
