...
public struct ClickDetailMember1: Codable {
    ...
    public init(emailId: String? = nil, emailAddress: String? = nil, mergeFields: [String:Any]? = nil, vip: Bool? = nil, clicks: Int? = nil, campaignId: String? = nil, urlId: String? = nil, listId: String? = nil, listIsActive: Bool? = nil, contactStatus: String? = nil, links: [ResourceLink]? = nil) {
