...
extension MailchimpKit.CustomerJourneys {
    ...
    */
    public enum PostCustomerJourneysJourneysIdStepsIdActionsTrigger {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(body: Body, options: Options, encoder: RequestEncoder? = nil) {
                ...
                super.init(service: PostCustomerJourneysJourneysIdStepsIdActionsTrigger.service) { defaultEncoder in
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "journey_id" + "}", with: "\(self.options.journeyId)").replacingOccurrences(of: "{" + "step_id" + "}", with: "\(self.options.stepId)")
            }
        }
        ...
        public enum Response: APIResponseValue, CustomStringConvertible, CustomDebugStringConvertible {
            ...
            public init(statusCode: Int, data: Data, decoder: ResponseDecoder) throws {
                switch statusCode {
                case 204: self = try .status204(decoder.decodeAny([String: CodableAny].self, from: data))
