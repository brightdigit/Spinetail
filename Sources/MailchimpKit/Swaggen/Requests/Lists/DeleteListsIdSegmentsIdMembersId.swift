...
extension MailchimpKit.Lists {
    ...
    */
    public enum DeleteListsIdSegmentsIdMembersId {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public init(options: Options) {
                ...
                super.init(service: DeleteListsIdSegmentsIdMembersId.service)
            }
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "list_id" + "}", with: "\(self.options.listId)").replacingOccurrences(of: "{" + "segment_id" + "}", with: "\(self.options.segmentId)").replacingOccurrences(of: "{" + "subscriber_hash" + "}", with: "\(self.options.subscriberHash)")
            }
        }
