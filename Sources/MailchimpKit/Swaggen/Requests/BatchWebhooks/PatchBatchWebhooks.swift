...
public extension MailchimpKit.BatchWebhooks {
  /**
  ...
  enum PatchBatchWebhooks {
    ...
    public final class Request: APIRequest<Response> {
      ...
      public init(body: Body, options: Options, encoder: RequestEncoder? = nil) {
        ...
        super.init(service: PatchBatchWebhooks.service) { defaultEncoder in
      ...
      override public var path: String {
        super.path.replacingOccurrences(of: "{" + "batch_webhook_id" + "}", with: "\(options.batchWebhookId)")
      }
    }
