...
extension MailchimpKit.BatchWebhooks {
    ...
    */
    public enum PatchBatchWebhooks {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "batch_webhook_id" + "}", with: "\(self.options.batchWebhookId)")
            }
        }
