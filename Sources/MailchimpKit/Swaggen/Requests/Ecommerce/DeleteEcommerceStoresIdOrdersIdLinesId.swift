...
extension MailchimpKit.Ecommerce {
    ...
    */
    public enum DeleteEcommerceStoresIdOrdersIdLinesId {
        ...
        public final class Request: APIRequest<Response> {
            ...
            public override var path: String {
                return super.path.replacingOccurrences(of: "{" + "store_id" + "}", with: "\(self.options.storeId)").replacingOccurrences(of: "{" + "order_id" + "}", with: "\(self.options.orderId)").replacingOccurrences(of: "{" + "line_id" + "}", with: "\(self.options.lineId)")
            }
        }
