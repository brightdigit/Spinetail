...
public struct ECommerceOrder1: Codable, Equatable, Content {
    ...
    public init(currencyCode: String, customer: ECommerceCustomer1, id: String, lines: [ECommerceOrderLineItem1], orderTotal: Double, billingAddress: BillingAddress1? = nil, campaignId: String? = nil, cancelledAtForeign: DateTime? = nil, discountTotal: Double? = nil, financialStatus: String? = nil, fulfillmentStatus: String? = nil, landingSite: String? = nil, orderURL: String? = nil, outreach: Outreach1? = nil, processedAtForeign: DateTime? = nil, promos: [PromosInner1]? = nil, shippingAddress: ShippingAddress1? = nil, shippingTotal: Double? = nil, taxTotal: Double? = nil, trackingCarrier: String? = nil, trackingCode: TrackingCode? = nil, trackingNumber: String? = nil, trackingURL: String? = nil, updatedAtForeign: DateTime? = nil) {
