...
public struct AbuseComplaint1: Codable, Equatable, Content {
    ...
    public init(links: [ResourceLink]? = nil, campaignId: String? = nil, date: DateTime? = nil, emailAddress: String? = nil, emailId: String? = nil, id: Int? = nil, listId: String? = nil, listIsActive: Bool? = nil, mergeFields: [String: [String: Any]]? = nil, vip: Bool? = nil) {
        self.links = links
