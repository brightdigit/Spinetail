...
public struct ECommercePromoRule: Codable, Equatable, Content {
    ...
    public init(links: [ResourceLink]? = nil, amount: Float? = nil, createdAtForeign: DateTime? = nil, description: String? = nil, enabled: Bool? = nil, endsAt: String? = nil, id: String? = nil, startsAt: DateTime? = nil, target: Target? = nil, title: String? = nil, type: `Type`? = nil, updatedAtForeign: DateTime? = nil) {
        self.links = links
        self.amount = amount
