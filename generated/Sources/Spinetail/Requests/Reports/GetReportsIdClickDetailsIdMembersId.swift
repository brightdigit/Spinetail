    ...
    */
    public struct GetReportsIdClickDetailsIdMembersId : ServiceCall {
        ...
        public var path: String {
            return Self.pathTemplate.replacingOccurrences(of: "{" + "campaign_id" + "}", with: "\(self.campaignId)").replacingOccurrences(of: "{" + "link_id" + "}", with: "\(self.linkId)").replacingOccurrences(of: "{" + "subscriber_hash" + "}", with: "\(self.subscriberHash)")
        }
